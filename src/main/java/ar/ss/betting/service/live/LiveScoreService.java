...
public class LiveScoreService {
    ...
    private LiveRoundSnapshot buildSnapshot(long roundId) {
        List<MatchEntity> matches = matchRepository.findByGameRoundIdOrderByMatchNumberAsc(roundId);
